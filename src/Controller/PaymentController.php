...
class PaymentController extends AbstractController
{
    ...
    public function payment(OrderRepository $repository, $reference, EntityManagerInterface $em): Response
    {
        ...
        Stripe::setApiKey('sk_test_51QguQa4KblrZKAGTGkYMeYGraxXCN6AkPxpQwNkzBON8lNXqGOMeWOvyteCatC3vhDIbFuycNnx2QLFKj1tptaYy00WKo03Kps');
        header('Content-Type: application/json');

        $request = Request::createFromGlobals();
        $YOUR_DOMAIN = $request->getSchemeAndHttpHost(); // This dynamically gets 'http://localhost:PORT'
